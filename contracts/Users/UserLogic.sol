...
contract UserLogic is RoleManagement, Updatable, RolesInterface {
    ...
    /// @notice funciton that can be called to create a new user in the storage-contract, only executable by user-admins!
    /// @notice if the user does not exists yet it will be create it, otherwise the older userdata will be overwritten
